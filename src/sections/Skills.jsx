...
// Este es un diccionario visual donde vinculo cada tecnología que manejo con su respectivo ícono.
// Me aseguro de mantener los colores de marca de cada tecnología para mayor autenticidad.
const skillIcons = {
...
// En esta sección organizo mis habilidades tanto técnicas (Hard Skills) como interpersonales (Soft Skills).
    ...
    <section className="container section" id="skills">
      <div className="section-inner">
        ...
        <div className="mt-10 w-full max-w-5xl mx-auto flex flex-col gap-8">
          ...
          {/* Habilidades Blandas */}
          <GlassCard padding="md" className="w-full overflow-hidden group mt-2">
            <div className="mb-6 flex justify-center">
              <h3 className="text-2xl sm:text-3xl font-bold text-foreground tracking-tight text-center">
                Habilidades Blandas
              </h3>
