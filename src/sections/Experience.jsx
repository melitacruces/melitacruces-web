...
export default function Experience() {
  ...
  return (
    <section className="container section" id="experience" aria-labelledby="experience-heading">
      <div className="section-inner">
        <div className="section-header">
          <SectionTitle id="experience-heading">Experiencia Profesional</SectionTitle>
        </div>
