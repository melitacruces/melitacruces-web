...
> **Este es mi sitio web e interfaz de portafolio profesional: interactivo, y optimizado, donde expongo mi trayectoria, proyectos y habilidades como Ingeniero Civil Industrial y Desarrollador Full Stack.**

---

## ▶️ Live Preview

**🔗 [Visitar Sitio Web](https://melitacruces.com)**
...
- **Diseño e Interactividad:** Paneles oscuros opacos con un intenso halo radial azul que sigue el movimiento del cursor (`Panel.jsx`) y una barra de navegación translúcida con desenfoque.
...
El portafolio implementa un estilo visual moderno, caracterizado por un fondo oscuro profundo nativo (`#080808`), tarjetas y contenedores oscuros opacos con bordes muy sutiles y un intenso halo radial azul que sigue el cursor, reservando el efecto de vidrio translúcido con desenfoque para la barra de navegación. Toda la tipografía está configurada en base a la fuente Montserrat importada desde Google Fonts para ofrecer una experiencia estética premium y legible.
